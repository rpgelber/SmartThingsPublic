...
definition(
    ...
    author: "Aaron Turner",
    description: "This is a service manager for the HTD (W)GW-SL1 Valet Smart Gateway\r\nhttps://www.htd.com/GW-SL1\r\nhttps://www.htd.com/GW-WSL1",
    category: "Fun & Social",
...
preferences {
    page(name: "searchTargetSelection", title: "HTD (W)GW-SL1 Search Target", nextPage: "deviceDiscovery") {
        section("Search Target") {
            input "searchTarget", "string", title: "Search Target", defaultValue: "urn:micasaverde-com:serviceId:HTD1", required: true
        }
    }
...
def deviceDiscovery() {
    ...
    return dynamicPage(
        name: "deviceDiscovery", title: "Discovery Started!", nextPage: "", refreshInterval: 5, 
